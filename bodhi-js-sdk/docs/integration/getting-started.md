...
- [Advanced Patterns](./advanced.md) -- Login with MCP access requests, agentic tool calling, extension SDK, error handling
- [Authentication](../authentication.md) -- OAuth flow details, token management
